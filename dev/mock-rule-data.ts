...
export const FIELDSDATA: Fields[] = [
  {
    ...
    id: '1',
    operators: [
      { name: 'equals', value: '=', label: 'Equals' },
  ...
  },
  {
    ...
    id: '3',
    operators: [{ name: 'greater_than', value: '>', label: 'Greater Than' }],
    valueEditorType: 'text',
    inputType: 'number',
  ...
  },
  {
    ...
    label: 'Range value',
    id: '5',
    operators: [{ name: 'between', value: 'between', label: 'Between' }],
    valueEditorType: 'text',
    inputType: 'text',
    values: [{ value: 'true', label: 'Yes' }],
  ...
  },
  {
    ...
    id: '5',
    operators: [{ name: 'equals', value: '=', label: 'Equals' }],
